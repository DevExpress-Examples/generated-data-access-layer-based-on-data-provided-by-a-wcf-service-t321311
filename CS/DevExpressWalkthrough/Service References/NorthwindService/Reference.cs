...
// Original file name:
// Generation date: 12/7/2015 12:09:06 PM
namespace DevExpressWalkthrough.NorthwindService
{
    ...
    public partial class NorthwindEntities : global::System.Data.Services.Client.DataServiceContext
    {
        ...
        {
            global::System.Type resolvedType = this.DefaultResolveType(typeName, "NorthwindModel", "DevExpressWalkthrough.NorthwindService");
        ...
        {
            if (clientType.Namespace.Equals("DevExpressWalkthrough.NorthwindService", global::System.StringComparison.Ordinal))
            {
        ...
        private abstract class GeneratedEdmModel
        {
            ...
            private const string ModelPart3 = "\"OrderID\" /></Key><Property Name=\"ShippedDate\" Type=\"Edm.DateTime\" Precision=\"3\" " +
                ...
                "ation></Schema><Schema Namespace=\"NorthwindService\" xmlns=\"http://schemas.micros" +
                "oft.com/ado/2009/11/edm\"><EntityContainer Name=\"NorthwindEntities\" m:IsDefaultEn" +
                "tityContainer=\"true\"><EntitySet Name=\"Categories\" EntityType=\"NorthwindModel.Cat" +
                "egory\" /><EntitySet Name=\"CustomerDemographics\" EntityType=\"NorthwindModel.Custo" +
                "merDemographic\" /><EntitySet Name=\"Customers\" EntityType=\"NorthwindModel.Custome" +
                "r\" /><EntitySet Name=\"Employees\" EntityType=\"NorthwindModel.Employee\" /><EntityS" +
                "et Name=\"Order_Details\" EntityType=\"NorthwindModel.Order_Detail\" /><EntitySet Na" +
                "me=\"Orders\" EntityType=\"NorthwindModel.Order\" /><EntitySet Name=\"Products\" Entit" +
                "yType=\"NorthwindModel.Product\" /><EntitySet Name=\"Regions\" EntityType=\"Northwind" +
                "Model.Region\" /><EntitySet Name=\"Shippers\" EntityType=\"NorthwindModel.Shipper\" /" +
                "><EntitySet Name=\"Suppliers\" EntityType=\"NorthwindModel.Supplier\" /><EntitySet N" +
                "ame=\"Territories\" EntityType=\"NorthwindModel.Territory\" /><EntitySet Name=\"Alpha" +
                "betical_list_of_products\" EntityType=\"NorthwindModel.Alphabetical_list_of_produc" +
                "t\" /><EntitySet Name=\"Category_Sales_for_1997\" EntityType=\"NorthwindModel.Catego" +
                "ry_Sales_for_1997\" /><EntitySet Name=\"Current_Product_Lists\" EntityType=\"Northwi" +
                "ndModel.Current_Product_List\" /><EntitySet Name=\"Customer_and_Suppliers_by_Citie" +
                "s\" EntityType=\"NorthwindModel.Customer_and_Suppliers_by_City\" /><EntitySet Name=" +
                "\"Invoices\" EntityType=\"NorthwindModel.Invoice\" /><EntitySet Name=\"Order_Details_" +
                "Extendeds\" EntityType=\"NorthwindModel.Order_Details_Extended\" /><EntitySet Name=" +
                "\"Order_Subtotals\" EntityType=\"NorthwindModel.Order_Subtotal\" /><EntitySet Name=\"" +
                "Orders_Qries\" EntityType=\"NorthwindModel.Orders_Qry\" /><EntitySet Name=\"Product_" +
                "Sales_for_1997\" EntityType=\"NorthwindModel.Product_Sales_for_1997\" /><EntitySet " +
                "Name=\"Products_Above_Average_Prices\" EntityType=\"NorthwindModel.Products_Above_A" +
                "verage_Price\" /><EntitySet Name=\"Products_by_Categories\" EntityType=\"NorthwindMo" +
                "del.Products_by_Category\" /><EntitySet Name=\"Sales_by_Categories\" EntityType=\"No" +
                "rthwindModel.Sales_by_Category\" /><EntitySet Name=\"Sales_Totals_by_Amounts\" Enti" +
                "tyType=\"NorthwindModel.Sales_Totals_by_Amount\" /><EntitySet Name=\"Summary_of_Sal" +
                "es_by_Quarters\" EntityType=\"NorthwindModel.Summary_of_Sales_by_Quarter\" /><Entit" +
                "ySet Name=\"Summary_of_Sales_by_Years\" EntityType=\"NorthwindModel.Summary_of_Sale" +
                "s_by_Year\" /><AssociationSet Name=\"FK_Products_Categories\" Association=\"Northwin" +
                "dModel.FK_Products_Categories\"><End Role=\"Categories\" EntitySet=\"Categories\" /><" +
                "End Role=\"Products\" EntitySet=\"Products\" /></AssociationSet><AssociationSet Name" +
                "=\"CustomerCustomerDemo\" Association=\"NorthwindModel.CustomerCustomerDemo\"><End R" +
                "ole=\"CustomerDemographics\" EntitySet=\"CustomerDemographics\" /><End Role=\"Custome" +
                "rs\" EntitySet=\"Customers\" /></AssociationSet><AssociationSet Name=\"FK_Orders_Cus" +
                "tomers\" Association=\"NorthwindModel.FK_Orders_Customers\"><End Role=\"Customers\" E" +
                "ntitySet=\"Customers\" /><End Role=\"Orders\" EntitySet=\"Orders\" /></AssociationSet>" +
                "<AssociationSet Name=\"FK_Employees_Employees\" Association=\"NorthwindModel.FK_Emp" +
                "loyees_Employees\"><End Role=\"Employees\" EntitySet=\"Employees\" /><End Role=\"Emplo" +
                "yees1\" EntitySet=\"Employees\" /></AssociationSet><AssociationSet Name=\"FK_Orders_" +
                "Employees\" Association=\"NorthwindModel.FK_Orders_Employees\"><End Role=\"Employees" +
